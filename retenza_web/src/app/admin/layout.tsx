...
import { LayoutDashboard, Store, User, LogOut, Search, ChevronRight, Settings } from 'lucide-react';
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen flex flex-col font-inter bg-[#F7F5F2]">
      ...
      <header className="h-[72px] bg-white border-b border-gray-200/60 flex items-center gap-4 px-6 lg:px-8 sticky top-0 z-40 shrink-0">
        ...
        <Link href="/admin" className="flex items-center gap-2.5 mr-6">
          <div className="w-8 h-8 rounded-lg bg-[#D85A30] flex items-center justify-center shrink-0 shadow-sm shadow-[#D85A30]/40">
