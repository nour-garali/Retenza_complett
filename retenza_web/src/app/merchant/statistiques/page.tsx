  ...
  return (
    <div className="flex-1 flex flex-col min-h-screen">
      <PageHeader
        ...
        subtitle="Suivi des revenus et conversions par campagne."
      >
        {/* Boutique Selector */}
        <select
          ...
          <div className="bg-white border border-slate-200 rounded-3xl shadow-sm overflow-hidden flex flex-col">
              <div className="p-6 border-b border-slate-100 flex flex-col md:flex-row md:items-center justify-between gap-4 bg-slate-50/60">
                ...
                <div className="flex items-center gap-2.5 flex-wrap">
                  ...
                  <button
                    onClick={() => {
                      const url = `http://localhost:5000/api/export/accounting?commerce_id=${encodeURIComponent(selectedCommerce)}`;
